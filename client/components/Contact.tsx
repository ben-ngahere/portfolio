    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div ref={contentRef} className="space-y-8">
          {/* Intro Message */}
          <div className="contact-card backdrop-blur-md bg-white/5 rounded-2xl p-8 border border-white/10 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {contactMethods.map((method) => {
              ...
              const content = (
                <div className={`contact-card backdrop-blur-md bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300 group ${method.href ? 'cursor-pointer' : ''}`}>
                  <div className="flex items-center space-x-4">
                    <IconComponent className={`w-6 h-6 text-gray-400 ${method.color} transition-colors`} />
                    <div className="text-left">
                      <h3 className="text-white font-medium mb-1">{method.label}</h3>
          ...
          {/* CV Download */}
          <div className="contact-card backdrop-blur-md bg-white/5 rounded-2xl p-8 border border-white/10">
            <p className="text-gray-300 mb-6">
              Download my CV for an overview of my experience, 
